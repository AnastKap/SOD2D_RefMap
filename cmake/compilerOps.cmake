...
elseif(CMAKE_C_COMPILER_ID STREQUAL "Clang")
	...
	if(NOT MPI_WITH_ROCM)
		...
		if(STORE_INTERMEDIATE_FILES)
			set(CMAKE_C_FLAGS ${CMAKE_C_FLAGS} "--save-temps -gpu=keep,nodebug")
			set(CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} "--save-temps -gpu=keep,nodebug")
			set(CMAKE_Fortran_FLAGS ${CMAKE_Fortran_FLAGS} "--save-temps -gpu=keep,nodebug")
		endif()
		# GPU options
		if(USE_GPU)
